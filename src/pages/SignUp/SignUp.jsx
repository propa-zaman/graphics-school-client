      ...
      .then(result => {
        ...
        updateUserProfile(data.name, data.photoURL)
          .then(() => {
            ...
            fetch('https://graphics-school-sever-propa-zaman.vercel.app/users', {
              method: 'POST',
              headers: {
    ...
    <>
      <div className="max-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
        <div className="sm:max-w-xl sm:mx-auto">
          <div className="bg-white px-4 py-10 mx-8 md:mx-0 shadow rounded-3xl sm:p-10 mt-20">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <input type="tel" {...register("phoneNumber", { required: true })} placeholder="Phone Number" className="input w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-700 focus:outline-none focus:border-violet-500" />
